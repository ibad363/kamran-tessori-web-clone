...
const Header = () => {
  return (
    <header className='fixed flex top-0 left-0 z-50 justify-around items-center bg-[#044e83] text-white w-full h-[13vh] p-2 max-md:flex-col'>
        <div><img src="/assets/logo.png" alt="Logo" className='w-24 h-28 absolute left-8 top-5 max-md:top-0'/></div>
